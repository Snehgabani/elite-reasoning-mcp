...
def _seed_prevention_rules(store: EliteStore):
    ...
    rules = [
        ("no_silent_stops", "after_tool_call",
        ...
        ("architecture_checklist", "before_design",
        ...
        ("track_implicit_requirements", "on_prompt",
