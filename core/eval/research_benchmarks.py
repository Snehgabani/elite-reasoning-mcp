...
TOOL_BUDGET_POLICIES: tuple[ToolBudgetPolicy, ...] = (
    ...
    ToolBudgetPolicy(
        ...
        max_tool_calls=3,
        max_latency_ms=4000,
        required_checks=("orchestrate_request_tool",),
    ...
    ToolBudgetPolicy(
        ...
        required_checks=("orchestrate_request_tool", "check_anti_patterns", "assess_confidence"),
    ...
    ToolBudgetPolicy(
        ...
        required_checks=("orchestrate_request_tool", "evidence_check", "socratic_challenge", "assess_confidence"),
