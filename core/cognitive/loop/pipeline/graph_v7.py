...
class ReasoningPipelineV7:
    ...
    MODES = {
        ...
        "standard": ["classify_route", "decompose", "select_framework", "generate_template", "quality_checklist"],
        "amplified": [
            "classify_route",
            "step_back",
            "decompose",
                ...
                [
                    {
                        ...
                        "validation": "Issue reproduced",
                    },
                    {
                        "index": 3,
                        "name": "diagnose",
                        "description": "Identify root cause",
                        "validation": "Root cause found",
                    },
    ...
    def _add_citations(self, techniques: list[str]) -> list[dict]:
        ...
        for tech in techniques:
            if tech in citation_map:
                citations.append(
                    {"technique": tech, "paper": citation_map[tech]["paper"], "title": citation_map[tech]["title"]}
                )
