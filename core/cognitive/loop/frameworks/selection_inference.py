...
class Selector:
    ...
    def select(self, context: List[str], question: str, previous_inferences: List[str] = None) -> List[str]:
        """
...
class SelectionInferenceFramework:
    ...
    def reason(self, context: List[str], question: str) -> Dict[str, Any]:
        ...
        for step_num in range(self.num_steps):
            ...
            selection = self.selector.select(current_context, question, previous_inferences)
