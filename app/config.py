...
class ConfigLoader:
    ...
    def _default_config(self) -> dict:
        return {
            "executive_llm": {"provider": "anthropic", "default_model": "claude-3-5-sonnet-20240620"},
            "reasoning_llm": {
                "provider": "deepseek",
            ...
            "watchdog": {"heartbeat_interval_sec": 300},
            "telemetry": {"langfuse_enabled": True, "deepeval_enabled": True},
        }
